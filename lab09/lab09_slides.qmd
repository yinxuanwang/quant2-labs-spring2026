...
A simulation-based framework for formalizing and evaluating research designs

- make assumptions explicit
- simulate how a study would perform under those assumptions
- compare alternative designs before fielding the study
- learn where bias, noise, and low power come from

## `DeclareDesign` Workflow
1. start with the research question
2. declare the data-generating process
3. declare the estimand
4. declare how the data are observed
5. declare the estimator
6. diagnose bias, uncertainty, coverage, and power
7. redesign over the choices we can control
...
factorial_diag$diagnosands_df %>%
  ...
  geom_point(size = 2) +
  labs(
    title = "Power in a 2x2 factorial design, interaction 0.2",
    x = "Sample size",
    y = "Power",
    color = "Estimand"
  ) +
